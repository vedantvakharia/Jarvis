- [[#Java Keywords|Java Keywords]]
		...
		- [[#Reserved but Unused|Reserved but Unused]]
- [[#Operator Precedence|Operator Precedence]]
- [[#Escape Sequences|Escape Sequences]]
- [[#Access Modifiers|Access Modifiers]]
	- [[#Access Modifiers#Public|Public]]
- [[#Conditional Statements|Conditional Statements]]
	- [[#Conditional Statements#Shadowing of variables|Shadowing of variables]]
	- [[#Conditional Statements#Switch statements|Switch statements]]
		- [[#Switch statements#1. Traditional `switch` statement|1. Traditional `switch` statement]]
			- [[#1. Traditional `switch` statement#Characteristics:|Characteristics:]]
			- [[#1. Traditional `switch` statement#Problems:|Problems:]]
		- [[#Switch statements#2. Enhanced `switch` statement (Java 12+ preview, Java 14 stable)|2. Enhanced `switch` statement (Java 12+ preview, Java 14 stable)]]
			- [[#2. Enhanced `switch` statement (Java 12+ preview, Java 14 stable)#Characteristics:|Characteristics:]]
		- [[#Switch statements#3.`switch` as an expression (Java 14)|3.`switch` as an expression (Java 14)]]
			- [[#3.`switch` as an expression (Java 14)#Characteristics:|Characteristics:]]
		- [[#Switch statements#4.`switch` expression with block (`yield`) (Java 14)|4.`switch` expression with block (`yield`) (Java 14)]]
			- [[#4.`switch` expression with block (`yield`) (Java 14)#Characteristics:|Characteristics:]]
- [[#Text Blocks|Text Blocks]]
	- [[#Text Blocks#The Problem: Multi-line Strings the Old Way|The Problem: Multi-line Strings the Old Way]]
	- [[#Text Blocks#The Solution: Text Block Syntax|The Solution: Text Block Syntax]]
	- [[#Text Blocks#Rules and features|Rules and features]]
		- [[#Rules and features#Indentation|Indentation]]
		- [[#Rules and features#Line Joining with Backslash (``)|Line Joining with Backslash (``)]]
		- [[#Rules and features#Trailing Whitespace and `\s`|Trailing Whitespace and `\s`]]
- [[#Static|Static]]
	- [[#Static#Static Variables|Static Variables]]
	- [[#Static#Static Methods|Static Methods]]
	- [[#Static#Static Blocks / Static Clause|Static Blocks / Static Clause]]
	- [[#Static#Static Nested Class|Static Nested Class]]
